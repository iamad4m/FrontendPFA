...
const Blacklisted = ({ blacklist, refetchTourists, refetchBlacklist }) => {
  const settings = {
    dots: true,
    infinite: false,
    speed: 500,
  ...
  return (
    <>
      <h1 className="text-2xl md:text-3xl pl-2 my-2 border-l-4  font-sans font-bold border-indigo-600  dark:text-gray-200 mx-5 mb-3 mt-4">
        Blacklisted Tourists
      </h1>
              ...
              <div className="bg-white shadow-xl border border-gray-200 rounded-lg py-3">
                ...
                <div className="p-2">
                  ...
                  <div className="flex justify-center mt-4">
                    <button
                      className="border border-green-500 text-green-500 px-4 py-2 rounded transition duration-300 ease-in-out hover:bg-green-500 hover:text-white"
                      onClick={() =>
                        axios.post(`/api/enable?id=${tourist.id}`).then((r) => {
                          refetchTourists();
                          refetchBlacklist();
                        })
                      }
